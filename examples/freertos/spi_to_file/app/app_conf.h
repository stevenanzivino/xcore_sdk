...
#define appconfVISION_TASK_PRIORITY (configMAX_PRIORITIES - 2)
#define appconfPERSON_DETECT_TASK_PRIORITY (configMAX_PRIORITIES - 3)
#define appconfSPI_CAMERA_TASK_PRIORITY (configMAX_PRIORITIES - 4)
